...
export interface Fish { id:string;name:string;texture:string;rarity:Rarity;value:number;xp:number;hookMs:number;difficulty:number;color:number;weightMin:number;weightMax:number;description:string;hint:string }
